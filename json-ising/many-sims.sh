...
cd /home/rcf-40/pralph/panfs/context/json-ising
...
do
    (
        ...
        # fit the model;
        Rscript ../fit-model.R -i simseqs/sim-$DIR/test-ising-3-root-1-tip-l1-shift0.counts -t .1 -m genmatrices/genmatrix-3-complete.RData -o simseqs/sim-$DIR/test-ising-fit-3-1-1.RData;
        Rscript ../fit-model.R -i simseqs/sim-$DIR/test-ising-4-root-2-tip-l1-shift0.counts -t .1 -m genmatrices/genmatrix-4-complete.RData -o simseqs/sim-$DIR/test-ising-fit-4-2-1.RData;
        Rscript ../fit-model.R -i simseqs/sim-$DIR/test-ising-5-root-3-tip-l1-shift0.counts -t .1 -m genmatrices/genmatrix-5-complete.RData -o simseqs/sim-$DIR/test-ising-fit-5-3-1.RData;
        Rscript ../fit-model.R -i simseqs/sim-$DIR/test-ising-6-root-2-tip-l2-shift0.counts -t .1 -m genmatrices/genmatrix-6-complete.RData -o simseqs/sim-$DIR/test-ising-fit-6-2-2.RData;
    ) &
done
