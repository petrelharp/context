...
Rscript ../fit-model.R -i simplus/plus-ising-01-4-root-2-tip-l1-shift0.counts -t .1 -m genmatrices/genmatrix-4-plus.RData -j 456 -c ising-model-plus.json
...
echo "mcmc also"
Rscript ../mcmc-model.R -i simplus/plus-ising-01-4-root-2-tip-l1-shift0-genmatrix-4-plus-456.RData -c ising-model-plus.json -t .1 -b 10
Rscript ../mcmc-model.R -i simplus/plus-ising-01-4-root-2-tip-l1-shift0-genmatrix-4-plus-456.RData -c ising-model-plus.json -t .1 -b 1000 -j 789
