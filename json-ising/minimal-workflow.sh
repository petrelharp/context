...
Rscript ../sim-seq.R -c ising-model.json -t .1 -s 1000 -d simseqs -o test-ising-123.RData
...
echo "mcmc also"
Rscript ../mcmc-model.R -i simseqs/test-ising-123-4-root-2-tip-l1-shift0-genmatrix-4-complete-456.RData -c ising-model.json -t .1 -b 10 -j 789
