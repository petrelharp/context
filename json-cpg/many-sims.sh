...
do
    (
        ...
        # fit the model;
        Rscript ../fit-model.R -c $MODEL -i simseqs/sim-$DIR/test-cpg-3-root-1-tip-l1-shift0.counts -m genmatrices/genmatrix-3-cpg.RData -o simseqs/sim-$DIR/test-cpg-fit-3-1-1.RData;
        ...
        Rscript ../fit-model.R -c $MODEL -i simseqs/sim-$DIR/test-cpg-4-root-2-tip-l1-shift0.counts -m genmatrices/genmatrix-4-cpg.RData -o simseqs/sim-$DIR/test-cpg-fit-4-2-1.RData;
        ...
        Rscript ../fit-model.R -c $MODEL -i simseqs/sim-$DIR/test-cpg-5-root-3-tip-l1-shift0.counts -m genmatrices/genmatrix-5-cpg.RData -o simseqs/sim-$DIR/test-cpg-fit-5-3-1.RData;
        ...
        Rscript ../fit-model.R -c $MODEL -i simseqs/sim-$DIR/test-cpg-6-root-2-tip-l2-shift0.counts -m genmatrices/genmatrix-6-cpg.RData -o simseqs/sim-$DIR/test-cpg-fit-6-2-2.RData;
