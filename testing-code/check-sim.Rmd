...
counts_table <- function(in_longwin, in_shortwin, half_n_show) {
    if ( in_longwin > longwin(genmatrix) || in_shortwin > longwin(genmatrix) ) {
        ...
        observed <- projectcounts( counttab, new.leftwin=floor((in_longwin-in_shortwin)/2), new.shortwin=in_shortwin, new.longwin=in_longwin, overlap=TRUE )
        expected <- projectcounts( expected, new.leftwin=floor((in_longwin-in_shortwin)/2), new.shortwin=in_shortwin, new.longwin=in_longwin, overlap=TRUE )
