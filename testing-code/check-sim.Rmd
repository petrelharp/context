...
counts_table <- function(in_longwin, in_shortwin, half_n_show) {
    if ( in_longwin > longwin(genmatrix) || in_shortwin > longwin(genmatrix) ) {
        ...
        observed <- projectcounts( counttab, lcountwin=floor((in_longwin-in_shortwin)/2), countwin=in_shortwin, rcountwin=ceiling((in_longwin-in_shortwin)/2) )
        expected <- projectcounts( expected, lcountwin=floor((in_longwin-in_shortwin)/2), countwin=in_shortwin, rcountwin=ceiling((in_longwin-in_shortwin)/2) )
...
counttab <- counttrans.list( list(longpats,longpats), simseqs=simseqs, leftwin=0, bases=simseq.config$bases )
