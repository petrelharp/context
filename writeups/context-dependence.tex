...
Credible intervals were somewhat too narrow, as the true value fell within 95\% credible intervals
for between 55\% and 90\% of the simulations;
which is likely due to remaining nonindependence at the window sizes used.
...
\begin{figure}
    ...
    \caption{
        ...
        from 60 MCMC runs on independently simulated sequences of $10^6$ bases
