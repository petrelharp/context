...
%EM I think I understand that the c is the number of tips on that side of the tree?
%EM So we should think about y and z below of concatenation of short sequences on the tips of the tree, and (y,z) as the concatenation operator?
...
\begin{enumerate}
  ...
  %EM I'm not sure why there is a single-item enumeration block here
    \begin{enumerate}
      \item let
        \begin{align}
          %EM Is there a typo here? (x,z) appears 2x
