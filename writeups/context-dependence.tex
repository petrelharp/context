...
\begin{example}[1-D Ising model with Glauber dynamics]
  ...
  and the energy associated with a given state $x$ is $H(x) = - \beta/2 \sum_i x_i x_{i+1} - \gamma/2 \sum_i x_i$.
  Here $\beta$ represents inverse temperature, and $\gamma$ represents the strength of the magnetic field.
