...
Assume here that $\ell$ has been chosen to be sufficiently large that approximation \eqref{eqn:window_approx} holds exactly.
...
that lies in the fringes of each window.
...
\peter{Ooops, yes.  Previously, I was semi-inconsistently thinking of the initial sequence $X(0)$ as random as well. ,
    which is why I was talking about Poisson instead of Multinomial counts.}
