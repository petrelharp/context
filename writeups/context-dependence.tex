...
\begin{figure}
    ...
    \caption{
        ...
        The red trapezoidal region represents the ``range of influence'',
...
%PR I think this is okay? x and y are not exactly the same here, but are still sequences?
%PR To me it seems less confusing than introducing another variable?
...
(see Figure \ref{Tmer-dependency}).
...
%PR I'll take your word for it! Wikipedia suggests either would do?
