...
The top and bottom of the table of (2,1,0) and (2,0,1) T-mer residuals of this model were as follows:
    \begin{center}
        XXX
    \end{center}
The situation clearly calls for addition of the CpG mutation tuple.
After adding these patterns into the model and re-fitting,
some length 2 residuals had statistically significant residuals,
but none nearly so large as those seen in (3,1,1) T-mer residuals:
    \begin{center}
        XXX
    \end{center}
\ldots which again clearly call for adding the appropriate 3mer mutation tuples.
After adding these in, no further (3,1,1) T-mer residuals achieved
statistical significance after a Bonferroni correction;
the final parameter values are shown in Table XXX;
