...
To begin, we fit an unconstrained model of single-nucleotide substitution
...
%PR True, but I'd like to show that the $z$-scores do down to something smaller?
%PR I've cut out four lines...
...
%PR No - I've added explanation - see above.
...
Futher theoretical work in this direction would be welcome.
In practice,
