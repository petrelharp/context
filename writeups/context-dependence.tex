...
\begin{itemize}
    \item[(basic)] 
      ...
      \item[(repair)] In addition to the above, a collection of motifs associated with known biochemical causes
          ...
          deamination due to repair of UV-induced pyramidine dimers ((\nT/\nC)\nC $\to$ (\nT/\nC)\nT and \nC\nC$\to$\nT\nT, \citet{uv_damage});
          an interaction between CpG and pyramidine dimers (\nT\nC\nG$\to$\nT\nT\nG and \nC\nC\nG$\to$\nC\nT\nG, \citet{cpg_review});
          repair of guanine adducts at CpG sites (\nC\nG$\to$\nC\nT, \citet{tobacco});
          deamination by AID (\nW\nR\nC\nY$\to$\nW\nR\nT\nY, \nW is \nA or \nT; \nR is \nA or \nG; \nY is \nT or \nC, \citet{AID});
          deamination by members of the APOBEC family (\nT\nC\nW$\to$\nT\nT\nW or \nT\nC\nW$\to$\nT\nG\nW, \citet{APOBEC});
          and repair by error-prone polymerases pol $\eta$ (\nW\nA$\to$\nW\nG, \citet{pol_eta});
          and pol $\iota$ (\nA\nA$\to$\nG\nT and \nA\nA$\to$\nA\nG \citet{pol_iota}):
          \begin{center}
            \begin{tabular}{c@{\quad$\to$\quad}c@{\quad at rate\quad }c|c@{\quad$\to$\quad}c@{\quad at rate\quad }c|c@{\quad$\to$\quad}c@{\quad at rate\quad }c}
                \nT\nC     &   \nT\nT      &  $\mu_{UV1}$ & \nA  &   \nG   &  $\mu_{r}$ & \nA  &   \nG   &  $\mu_{v}$ \\
...
% [ [ "CC", "CT" ], [ "GG", "AG" ] ], UV2
% [ [ "CC", "TT" ], [ "GG", "AA" ] ], UV3
% [ [ "TCG", "TTG" ], [ "CCG", "CTG" ], [ "CGA", "CAA" ], [ "CGG", "CAG" ] ], mUV
% [ [ "CG", "CT" ], [ "CG", "AG" ] ],
