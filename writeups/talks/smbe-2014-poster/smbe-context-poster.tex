...
\begin{poster}%
  ...
  \makebox[10em][r]{%
    \begin{minipage}{10em}
       \hfill
       \includegraphics[width=10em]{USC-seal} \\
    \end{minipage}
    }
  }
  % Title
  ...
  % Project logo
  {
    \makebox[10em][r]{%
      \begin{minipage}{10em}
        \hfill
        \includegraphics[width=10em]{../../contextual-logo}
      \end{minipage}
    }
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Idea: count asymmetric tuples}{name=windows,column=0,span=1,below=grammar}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\parbox[b]{.55\textwidth}{
    ...
    \begin{itemize}
      ...
      \item a site is unlikely to be affected by context further away than, say, $k^2 \mu t$.
    ...
    \begin{flushright}
      \includegraphics[width=.4\textwidth]{../../../writeup-plots/talk-tasep-fig-3}
    \end{flushright}
    \vspace{2em}
...
compute exact transition probabilities using $w$-tuples;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Exact solution}{name=exact,column=0,span=1,below=windows}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\textbf{Tricks:} Krylov methods to compute $e^{tG}v$ for sparse $G$;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Real data}{name=data,column=1,below=simulation}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Code: \texttt{http://github.com/petrelharp/context}
  \scriptsize
