...
\begin{frame}{What was the question again?}
  ...
  {\struct Note:} \[ e^{tG} = I + G + \frac{t^2}{2} G^2 + \frac{t^3}{6} G^3 + \cdots \]
        ...
        \begin{column}{0.5\textwidth}
          ...
          % \begin{center} \setlength{\tabcolsep}{0pt} \begin{tabular}{lccccccccccccccccccccccccccccccccccccccccccccccccccccc}
          %     $x:$\hspace{1em} &{C}&C&{C}&A&G&T&C&C&A&G&A&T&A&A&A&A&T&T&G&A&T\\
          %              &&&&&&&&&&&&&&&&&&&&&&&&&&\\
          %              &&&&&&&&&&&&&&&&&&&&&&&&&&\\
          %     $y:$\hspace{1em} &{C}&A&{C}&A&G&T&C&C&A&G&A&T&A&A&A&A&T&C&G&A&T\\
