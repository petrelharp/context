...
To get confidence intervals, we need to either simulate, or do something different.
...
Also note that the further calculations in the phylogenetic case can be done using these methods.
To compute
\[
